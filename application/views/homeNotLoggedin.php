...
<form action="<?PHP echo baseUrl("user/signup") ?>" method="post">
	...
	<p><input type="text" name="signup_username" placeholder="Pick a username" onblur="checkUsername(this.value)" />
	<div id="emailError"></div>
	<p><input type="text" name="signup_email" placeholder="Email" onblur="checkEmail(this.value)"/>
